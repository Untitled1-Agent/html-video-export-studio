...
| K-09 | Open: repository license decision | No project license was selected in the supplied source. Owner should choose a license and confirm third-party obligations before public distribution. Publishing defaults to private. |
